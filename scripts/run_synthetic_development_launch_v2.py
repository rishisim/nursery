...
from babyworld_lite.development_launch_v2.study import (
    compute_from_persisted,
    execute_cohort,
)

CONFIG = "configs/synthetic_development_launch_v2.yaml"
PROTOCOL = "docs/synthetic_development_launch_v2_protocol.md"
SOURCES = "docs/synthetic_development_launch_v2_primary_sources.json"
TRACEABILITY = "docs/synthetic_development_launch_v2_traceability.json"
LIMITATIONS = "docs/synthetic_development_launch_v2_limitations.md"
SAMPLE_SIZE = "docs/synthetic_development_launch_v2_sample_size.md"
REPAIR_LEDGER = "docs/synthetic_development_launch_v2_repair_ledger.json"
OUTPUT = ROOT / "output/synthetic_development_launch_package_v2"
TRACKED = (
    ...
    "babyworld_lite/development_launch_v2/__init__.py",
    "babyworld_lite/development_launch_v2/protocol.py",
    "babyworld_lite/development_launch_v2/statistics.py",
    "babyworld_lite/development_launch_v2/study.py",
    "babyworld_lite/development_launch_v2/adjudicator.py",
    "babyworld_lite/development_launch_v2/integrity.py",
    "scripts/run_synthetic_development_launch_v2.py",
    "tests/conftest.py",
    "tests/test_synthetic_development_launch_v2.py",
    ...
    "output/synthetic_development_launch_package_v2/outcome_registry.json",
    "output/synthetic_development_launch_package_v2/fixture_rehearsal/cohort_summary.json",
    "output/synthetic_development_launch_package_v2/fixture_rehearsal/identifier_reference_audit.json",
    "output/synthetic_development_launch_package_v2/fixture_rehearsal/recomputable/development_controls.json",
    "output/synthetic_development_launch_package_v2/fixture_rehearsal/recomputable/development_inference.json",
    CONFIG,
    PROTOCOL,
    SOURCES,
    TRACEABILITY,
