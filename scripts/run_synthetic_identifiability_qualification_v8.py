...
from babyworld_lite.sensor_alignment_v8.adjudicator import adjudicate_file
...
from babyworld_lite.sensor_alignment_v8.study import compute_from_persisted, execute_qualification

CONFIG = "configs/synthetic_identifiability_qualification_v8.yaml"
PROTOCOL = "docs/synthetic_identifiability_qualification_v8_protocol.md"
SOURCES = "docs/synthetic_identifiability_qualification_v8_primary_sources.json"
TRACEABILITY = "docs/synthetic_identifiability_qualification_v8_traceability.json"
AUDIT = "docs/synthetic_identifiability_qualification_v8_v5_v7_audit.json"
REPAIR_LEDGER = "docs/synthetic_identifiability_qualification_v8_repair_ledger.json"
OUTPUT = ROOT / "output/synthetic_identifiability_qualification_v8"
TRACKED = (
    ...
    "babyworld_lite/sensor_alignment_v8/study.py",
    "babyworld_lite/sensor_alignment_v8/adjudicator.py",
    "babyworld_lite/sensor_alignment_v8/integrity.py",
    ...
    "output/synthetic_identifiability_qualification_v7/terminal_decision.json",
    "output/synthetic_identifiability_qualification_v7/qualification_run/qualification_summary.json",
    "output/synthetic_identifiability_qualification_v7/qualification_run/corpus_audits.json",
    "output/synthetic_identifiability_qualification_v8/fixture_probe_0_failure.json",
    "output/synthetic_identifiability_qualification_v8/fixture_construction_probe_1/corpus_audit.json",
    "output/synthetic_identifiability_qualification_v8/fixture_construction_probe_1/operation_log.json",
    "output/synthetic_identifiability_qualification_v8/fixture_validation_official/qualification_summary.json",
    "output/synthetic_identifiability_qualification_v8/fixture_validation_official/corpus_audits.json",
    "output/synthetic_identifiability_qualification_v8/fixture_validation_official/detector_capacity_audit.json",
    "output/synthetic_identifiability_qualification_v8/fixture_validation_official/identifier_reference_audit.json",
    "output/synthetic_identifiability_qualification_v8/fixture_validation_official/recomputable/core_gates.json",
    "output/synthetic_identifiability_qualification_v8/fixture_validation_official/recomputable/null_capacity_audit.json",
    CONFIG,
    PROTOCOL,
    SOURCES,
    TRACEABILITY,
    AUDIT,
    REPAIR_LEDGER,
    "docs/synthetic_identifiability_qualification_v8_limitations.md",
)
    ...
    if args.command == "recompute":
        ...
        if args.command == "baseline":
            result = write_prior_preservation_baseline(
                ROOT,
                OUTPUT / "preserved_v1_v7_hashes_before.tsv",
            )
            ...
            result = verify_prior_preservation(
                ROOT,
                OUTPUT / "preserved_v1_v7_hashes_before.tsv",
                OUTPUT / "preserved_v1_v7_hashes_after.tsv",
