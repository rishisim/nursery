...
from babyworld_lite.sensor_alignment_v6.adjudicator import adjudicate_file
...
from babyworld_lite.sensor_alignment_v6.study import compute_from_persisted, execute_qualification

CONFIG = "configs/synthetic_identifiability_qualification_v6.yaml"
PROTOCOL = "docs/synthetic_identifiability_qualification_v6_protocol.md"
SOURCES = "docs/synthetic_identifiability_qualification_v6_primary_sources.json"
TRACEABILITY = "docs/synthetic_identifiability_qualification_v6_traceability.json"
OUTPUT = ROOT / "output/synthetic_identifiability_qualification_v6"
TRACKED = (
    ...
    "babyworld_lite/sensor_alignment_v6/__init__.py",
    "babyworld_lite/sensor_alignment_v6/protocol.py",
    "babyworld_lite/sensor_alignment_v6/benchmark.py",
    "babyworld_lite/sensor_alignment_v6/detector_runtime.py",
    "babyworld_lite/sensor_alignment_v6/learner.py",
    "babyworld_lite/sensor_alignment_v6/controls.py",
    "babyworld_lite/sensor_alignment_v6/study.py",
    "babyworld_lite/sensor_alignment_v6/adjudicator.py",
    "babyworld_lite/sensor_alignment_v6/integrity.py",
    "scripts/run_synthetic_identifiability_qualification_v6.py",
    "tests/test_synthetic_identifiability_qualification_v6.py",
    CONFIG,
    PROTOCOL,
    SOURCES,
    TRACEABILITY,
    "docs/synthetic_identifiability_qualification_v6_v4_disposition.md",
    "docs/synthetic_identifiability_qualification_v6_limitations.md",
)
    ...
    if args.command == "recompute":
        ...
        if args.command == "collect":
            ...
            result = verify_prior_preservation(
                ROOT,
                OUTPUT / "preserved_v1_v5_hashes_before.tsv",
                OUTPUT / "preserved_v1_v5_hashes_after.tsv",
