...
from babyworld_lite.development_launch_v1.integrity import (
...
from babyworld_lite.development_launch_v1.study import (
    compute_from_persisted,
    execute_cohort,
)

CONFIG = "configs/synthetic_development_launch_v1.yaml"
PROTOCOL = "docs/synthetic_development_launch_v1_protocol.md"
SOURCES = "docs/synthetic_development_launch_v1_primary_sources.json"
TRACEABILITY = "docs/synthetic_development_launch_v1_traceability.json"
LIMITATIONS = "docs/synthetic_development_launch_v1_limitations.md"
SAMPLE_SIZE = "docs/synthetic_development_launch_v1_sample_size.md"
REPAIR_LEDGER = "docs/synthetic_development_launch_v1_repair_ledger.json"
OUTPUT = ROOT / "output/synthetic_development_launch_package_v1"
TRACKED = (
    ...
    "babyworld_lite/development_launch_v1/__init__.py",
    "babyworld_lite/development_launch_v1/protocol.py",
    "babyworld_lite/development_launch_v1/statistics.py",
    "babyworld_lite/development_launch_v1/study.py",
    "babyworld_lite/development_launch_v1/adjudicator.py",
    "babyworld_lite/development_launch_v1/integrity.py",
    ...
    "output/synthetic_development_launch_package_v1/outcome_registry.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal/failure.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_2/cohort_summary.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_2/recomputable/development_inference.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_3/cohort_summary.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_3/recomputable/development_inference.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_4/cohort_summary.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_4/identifier_reference_audit.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_4/recomputable/development_controls.json",
    "output/synthetic_development_launch_package_v1/fixture_rehearsal_4/recomputable/development_inference.json",
    CONFIG,
    PROTOCOL,
    SOURCES,
    TRACEABILITY,
    ...
    if args.command == "recompute":
        ...
        if args.command == "baseline":
            ...
            result = write_prior_preservation_baseline(
                ROOT,
                OUTPUT / "preserved_v1_v8_hashes_before.tsv",
            )
            ...
            result = verify_prior_preservation(
                ROOT,
                OUTPUT / "preserved_v1_v8_hashes_before.tsv",
                OUTPUT / "preserved_v1_v8_hashes_after.tsv",
