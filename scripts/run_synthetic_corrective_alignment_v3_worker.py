...
EXPECTED_PARALLEL = SOURCE_ROOT / "babyworld_lite/corrective_alignment_v3/parallel.py"
FAILURE_SCHEMA = "nursery-corrective-subprocess-failure-v3"
REQUEST_SCHEMA = "nursery-corrective-subprocess-request-v3"
...
def _import_parallel():
    ...
    from babyworld_lite.corrective_alignment_v3 import parallel as parallel
