...
def main() -> None:
    ...
    require(pilot["status"] in {"p0_complete", "p1_complete", "p2_complete", "p3_complete", "p4_incomplete", "p4_complete", "p5_complete", "p6_complete", "p7_complete", "p8_complete", "p9_complete"}, "pilot P0 contract is not preserved")
