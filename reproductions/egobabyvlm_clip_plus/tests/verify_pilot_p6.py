...
def main():
    ...
    require(P["pilot_stage"] in {"P7","P8","P9"} and P["status"] in {"p7_complete","p8_complete","p9_complete"} and P["next_stage"] in {"P8","P9","mandatory_full_reproduction_reset_and_readiness_gates"} and not P["next_stage_started"],"canonical lifecycle stale")
