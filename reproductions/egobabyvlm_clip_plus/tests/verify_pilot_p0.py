...
def main() -> None:
    ...
    require(decision["status"] in {"p0_complete", "p1_complete", "p2_complete", "p3_complete", "p4_incomplete", "p4_complete", "p5_complete", "p6_complete", "p7_complete", "p8_complete", "p9_complete"}, "P0 status is not preserved")
    require(config["pilot_stage"] in {"P0", "P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8", "P9"}, "unexpected pilot stage")
