...
def validate_phase_state(config: Mapping[str, Any]) -> None:
    ...
    active_markers = (
        ...
        "PHASE4_PRIOR_RESULTS_PRESERVED_PUBLIC_ONLY_CALIBRATION_READINESS_SIBLING_MOUNT_REPAIR_FROZEN",
        "PHASE4_PRIOR_RESULTS_PRESERVED_PUBLIC_ONLY_CALIBRATION_READINESS_VAST_L4_RESOURCE_FROZEN",
    )
