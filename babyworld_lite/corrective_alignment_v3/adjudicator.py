...
def package_decision(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema_version": "nursery-corrective-package-terminal-v3",
...
def authorization_payload(**values: Any) -> dict[str, Any]:
    payload = {
        "schema_version": "nursery-corrective-development-authorization-v3",
        "protocol_id": PROTOCOL_ID,
...
def verify_authorization(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if value.get("schema_version") != "nursery-corrective-development-authorization-v3":
