...
def environment_record(
    ...
    return {
        "schema_version": "nursery-corrective-environment-lock-v3",
...
def freeze_prefreeze_evidence(package_root: str | Path) -> dict[str, Any]:
    ...
    contract = {
        "schema_version": "nursery-corrective-prefreeze-evidence-contract-v3",
...
def verify_prefreeze_evidence(package_root: str | Path) -> dict[str, Any]:
    ...
    if (
        ...
        != "nursery-corrective-prefreeze-evidence-contract-v3"
...
def freeze_snapshot(
    ...
    *,
    ...
    config_path = snapshot / "configs/synthetic_corrective_alignment_v3.yaml"
...
def verify_snapshot(snapshot_root: str | Path) -> dict[str, Any]:
    ...
    checks = {
        ...
        == "nursery-corrective-freeze-receipt-v3",
        ...
        == sha256_file(snapshot / "configs/synthetic_corrective_alignment_v3.yaml"),
        "frozen_runner_sha256": receipt.get("frozen_runner_sha256")
        == sha256_file(snapshot / "scripts/run_synthetic_corrective_alignment_v3.py"),
...
def compare_adjudication_trees(
    ...
    return {
        "schema_version": "nursery-corrective-parallel-equivalence-v3",
...
def benchmark_report(
    *,
    ...
    return {
        "schema_version": "nursery-corrective-parallel-benchmark-v3",
...
def validate_benchmark_report(
    ...
    *,
    ...
    checks = {
        ...
        == "nursery-corrective-parallel-benchmark-v3",
    ...
    return {
        "schema_version": "nursery-corrective-benchmark-validation-v3",
...
def verify_prior_preservation(
    ...
    *,
    ...
    proof = {
        "schema_version": "nursery-corrective-preservation-proof-v3",
        "status": "PASS" if passed else "FAIL",
...
def reverify_prior_preservation(
    ...
    *,
    ...
    return {
        "schema_version": "nursery-corrective-preservation-reverification-v3",
        "status": "PASS" if all(checks.values()) else "FAIL",
        "checks": checks,
    ...
    report = {
        ...
        "evidence_bindings": {
            ...
            "config_sha256": sha256_file(
                root / "configs/synthetic_corrective_alignment_v3.yaml"
            ),
...
def validate_official_test_report(
    ...
    *,
    ...
    checks = {
        "schema": set(report) == expected_fields
        and report.get("schema_version") == "nursery-corrective-official-tests-v3",
    ...
    return {
        "schema_version": "nursery-corrective-official-tests-validation-v3",
        "status": "PASS" if all(checks.values()) else "FAIL",
        "checks": checks,
...
def recompute_comparison_value(
    ...
    return {
        "schema_version": "nursery-corrective-recompute-comparison-v3",
        "status": "PASS" if passed else "FAIL",
...
def repository_operation_census(
    ...
    return {
        "schema_version": "nursery-corrective-repository-operation-census-v3",
        "status": "PASS" if passed else "FAIL",
...
def reverify_prior_closed_line(repository_root: str | Path) -> dict[str, Any]:
    ...
    return {
        "schema_version": "nursery-corrective-prior-line-reverification-v3",
        "status": "PASS" if all(checks.values()) else "FAIL",
        "checks": checks,
...
def finalize_package(
    ...
    *,
    ...
    snapshot = package / "frozen_source_snapshot"
    runner = snapshot / "scripts/run_synthetic_corrective_alignment_v3.py"
    values = {
