...
def write_prior_preservation_baseline(
    ...
    return {
        ...
        "versions_preserved": [1, 2, 3, 4, 5, 6],
    }
...
def freeze_package(
    ...
    *,
    ...
    adjudication_contract = {
        ...
        "terminal_decision_function": "babyworld_lite/sensor_alignment_v7/adjudicator.py:terminal_decision",
    }
...
def _snapshot_command(
    ...
    *,
    ...
    script = snapshot / "scripts/run_synthetic_identifiability_qualification_v7.py"
...
def run_negative_recompute_tests(output_root: str | Path) -> dict[str, Any]:
    ...
    source_target = source_copy / "babyworld_lite/sensor_alignment_v7/__init__.py"
...
def run_official_tests(repository_root: str | Path, output_root: str | Path) -> dict[str, Any]:
    ...
    report = {
        ...
        "order": "v7 tests first, then complete repository tests root",
...
def write_complete_manifest(output_root: str | Path) -> dict[str, Any]:
    ...
    manifest = {
        "protocol_id": "synthetic-identifiability-qualification-v7",
    ...
    gates.update(
        {
            ...
            "prior_v1_v6_preservation": preservation["status"] == "PASS",
            "traceability": True,
