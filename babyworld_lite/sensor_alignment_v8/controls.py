    ...
    for row in visible:
        ...
        for item in row["utterance"]["items"]:
            ...
            if key_row["grounded"]:
                ...
                null_updates += 1
    model = _model_from_counts(counts, model_seed=model_seed, learner="v8_oracle_alignment_control")
    return model, {
    ...
    for prompt in prompts:
        ...
        for item in prompt["tokens"]:
            ...
            if candidate.get("null_option"):
                ...
                observation_updates += 1
    model = _model_from_counts(counts, model_seed=model_seed, learner="v8_direct_capacity_control")
    return model, {
