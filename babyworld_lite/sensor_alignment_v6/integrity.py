...
def freeze_package(
    ...
    *,
    ...
    adjudication_contract = {
        ...
        "terminal_decision_function": "babyworld_lite/sensor_alignment_v6/adjudicator.py:terminal_decision",
    }
...
def _snapshot_command(
    ...
    *,
    ...
    script = snapshot / "scripts/run_synthetic_identifiability_qualification_v6.py"
...
def run_negative_recompute_tests(output_root: str | Path) -> dict[str, Any]:
    ...
    source_target = source_copy / "babyworld_lite/sensor_alignment_v6/__init__.py"
...
def run_official_tests(repository_root: str | Path, output_root: str | Path) -> dict[str, Any]:
    ...
    report = {
        ...
        "order": "v6 tests first, then complete repository tests root",
    ...
    gates.update(
        {
            ...
            "prior_v1_v5_preservation": preservation["status"] == "PASS",
            "traceability": True,
