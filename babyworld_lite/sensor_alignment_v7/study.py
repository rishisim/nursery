...
def _tie_probe(
    ...
    *,
    ...
    metric_a = score_predictions(
        first,
        [{"prompt_id": "v7-tie-probe", "answer_index": 0}],
        config,
        firewall,
        corpus_seed=corpus_seed,
        model_seed=model_seed,
    ...
    metric_b = score_predictions(
        second,
        [{"prompt_id": "v7-tie-probe", "answer_index": 1}],
        config,
        firewall,
        corpus_seed=corpus_seed,
        model_seed=model_seed,
...
def execute_qualification(
    ...
    *,
    ...
    if purpose not in {"fixture_only", "excluded_smoke"}:
        raise PermissionError("v7 may only execute fixture or the one excluded smoke")
    ...
    top_gates = {
        **core["gates"],
        ...
        "development_outcome_count_zero": True,
    ...
    write_json(
        output / "seed_operation_log.json",
        {
            ...
            "prior_v1_v6_identifiers_touched": [],
        },
    )
