...
def load_config(
    ...
    *,
    ...
    if int(value["protocol"].get("package_version", -1)) != 2:
    ...
    if (
        ...
        raise ValueError("frozen Python startup-flag contract mismatch")
...
def issue_development_capability(
    *,
    ...
    if (
        ...
        != "nursery-corrective-authorization-consumption-v2"
    ...
    if (
        ...
        or package.name != "synthetic_corrective_development_launch_package_v2"
...
def verify_development_capability(
    ...
    *,
    ...
    if (
        ...
        != "nursery-corrective-capability-issuance-v2"
...
def registry_snapshot(config: Mapping[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "nursery-corrective-registry-v2",
